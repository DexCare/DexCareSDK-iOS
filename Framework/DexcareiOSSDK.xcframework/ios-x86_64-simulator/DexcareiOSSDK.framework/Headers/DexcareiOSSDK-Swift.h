...
#ifndef DEXCAREIOSSDK_SWIFT_H
#define DEXCAREIOSSDK_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="DexcareiOSSDK",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
IB_DESIGNABLE
SWIFT_CLASS("_TtC13DexcareiOSSDK25SkyFloatingLabelTextField")
...
SWIFT_CLASS("_TtC13DexcareiOSSDK33SkyFloatingLabelTextFieldWithIcon")
