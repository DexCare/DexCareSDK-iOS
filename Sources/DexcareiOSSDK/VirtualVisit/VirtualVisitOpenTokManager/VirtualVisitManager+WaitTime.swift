...
extension VirtualVisitOpenTokManager {
    ...
    private func logWaitOfflineServerLog(
        canWaitOffline: Bool,
        ...
        serverLogger?.postMessage(
            message: "Wait Offline button is \(visibleString)",
            data: [
                "estimatedWaitTime": String(estimatedWaitTime),
