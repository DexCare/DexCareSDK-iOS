...
class EmbeddedVideoViewController: UIViewController {
    @IBOutlet private(set) weak var pausedOverlayView: UIView!
    @IBOutlet private(set) weak var replayOverlayView: UIView!
    @IBOutlet private(set) weak var replayLabel: UILabel!
    @IBOutlet private(set) weak var videoOverlayImageView: UIImageView!
    ...
    typealias VideoEventCallback = () -> Void
    ...
    func loadVideo(url: URL) {
        ...
        videoObservation = playerItem.observe(\AVPlayerItem.status, options: .new, changeHandler: { playerItem, _ in
