...
let networkTaskDidStartNotification: NetworkNotification = NetworkNotification()
let networkTaskDidCompleteNotification: NetworkNotification = NetworkNotification()
